...
@section('content')
    <div class="container-fluid">
        ...
        <form method="post"
                            ...
                            <div class="form-grid-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="destinationPoint"
                                        value="{{ old('destinationPoint', $tour->destinationPoint) }}" class="modern-input">
                                </div>
                            </div>
            ...
            <div class="modern-card" style="display:none;">
                    ...
                    <div class="hotel-card" data-slot="1">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="modern-upload-area hotel-image-preview"
                                    onclick="this.nextElementSibling.click()" style="width: 150px;">
                                    <i class="bi bi-patch-plus"></i> Thêm ảnh
                                </div>
                                <input type="file" class="hotel-image" accept="image/*" name="hotel_images[]"
                                    style="display: none;">
                            </div>
                        </div>
                    </div>
            ...
            <input type="hidden" name="hotels" id="hotelsInput" value="" />
        </form>
    </div>
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                // Hotels removed: do nothing
            });

            // Removed hotels initializer
            ...
            // Hotels removed: no initializer

            // <CHANGE> Updated hotel image preview with modern styling
            // Hotels removed: no image preview handler
            ...
            form.addEventListener('submit', (e) => {
                ...
                // Hotels removed: ensure hidden field stays empty
                hotelsInput.value = '';
            });
