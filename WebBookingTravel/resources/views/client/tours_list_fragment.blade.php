        ...
        <div class="tour-card h-100">
            ...
            <div class="tour-body">
                ...
                <div class="tour-price">
                    ...
                    @endphp
                    @if(!is_null($adult))
                    <div class="price-main">Từ <span class="amount">{{ number_format($adult, 0, ',', '.') }}đ</span> <span class="unit">/ người lớn</span></div>
                    @elseif(!is_null($child))
                    <div class="price-main">Từ <span class="amount">{{ number_format($child, 0, ',', '.') }}đ</span> <span class="unit">/ trẻ em</span></div>
                    @else
            ...
            <div class="tour-actions">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('client.tours.show', $tour->tourID) }}">Xem chi tiết</a>
